...
def _build_system_instruction(preferences: dict | None = None) -> str:
    ...
    return (
        ...
        "     - Solo trip = group size of 1\n"
        "     - Couple trip = group size of 2\n"
        "     - For other group types (family, friends, business), ALWAYS ask the user for the exact group size.\n\n"
        ...
        "IMPORTANT: Before calling finalize_trip_plan, you MUST present a summary of ALL\n"
        "gathered information to the user and ask for explicit confirmation:\n"
        "  - Destination\n"
        "  - Start date and end date\n"
        "  - Trip purpose\n"
        "  - Group type and size\n"
        "  - Any special preferences the user mentioned (dietary restrictions, hotel tier, travel style, budget, flight preferences)\n\n"
        "Format the confirmation like:\n"
        "```\n"
        "I've gathered the following trip details. Please confirm before I generate your plan:\n"
        "- **Destination:** ...\n"
        "- **Dates:** ... to ...\n"
        "- **Purpose:** ...\n"
        "- **Group:** ... (... people)\n"
        "- **Preferences:** ...\n"
        "Should I proceed with generating your trip plan? (yes/confirm)\n"
        "```\n\n"
