...
async def finalize_trip_plan(
    ...
    context_prompt = (
        ...
        "- Activity: wiki_url, map_url, opening_hours, admission_fee_hkd, rating, review_count, tips, image_url, thumbnail_url, booking_url, address\n"
...
def _build_system_instruction(preferences: dict | None = None) -> str:
    ...
    return (
        ...
        "CRITICAL: You MUST copy these fields DIRECTLY from tool results without modification:\n"
        "- Activity: wiki_url, map_url, opening_hours, admission_fee_hkd, rating, review_count, tips, image_url, thumbnail_url, booking_url, address\n"
        "- Hotel: hotel_class_int, reviews, location_rating, amenities, description, star_rating, guest_rating, image_url, embed_map_url\n"
