https://oneuptime.com/blog/post/2026-02-17-how-to-build-a-streaming-function-call-application-with-gemini-on-vertex-ai/view
How to Build a Streaming Function Call Application with Gemini on Vertex AI
Learn how to build streaming function call applications with Gemini on Vertex AI for responsive AI agents that execute tools in real time.
...
Execute function
Return result
Send result, continue streaming
Text chunk 3 (with tool result)
Display chunk 3
